...
const Anthology = props => (
  <div className='anthology'>
    ...
    <div className='container'>
      ...
      survived, who has gone to the end of experience and is dead. But neither the historians nor the
      sociologists have so far resolved this contradiction: how to invite these true witnesses, the dead,
      to their conferences? How can they be made to speak?</blockquote>
      <p className='center-text'>&mdash;Jorge Semprún, <span className='italic'>Le mort qu’il faut</span> (The Required Dead Man) (Paris: Gallimard, 2001). Translated and quoted by G. Hartman in "Testimony and Authenticity", published in G. Hartman, <span className='italic'>Scars of the Spirit</span>, (New York: Palgrave Macmillan, 2002). p. 91.</p>
      ...
      <p><span className='italic'>Let Them Speak</span> features testimonial fragments in eight cross-cultural experience domains (at the moment only 5 of them are accessible). Testimonial fragments are presented as a hierarchical tree. The main leaves of the tree denote the eight experience domains. By clicking on a leaf, readers are presented with groups of testimonial fragments describing a similar recurring experience, as well as prototypical experiences in a given experience domain (the top branches of the opened tree). By clicking on a fragment, the user can read, listen or watch original testimony. </p>
      <div className='center-text'>
        <Link className='button brown' to='/tree'>Let's explore</Link>
      </div>
      <p><span className='italic'>Let Them Speak</span> is not only the title of this book. It is an approach that, on the one hand, presents victims’ perspective by making survivors speak about their experiences and how they felt about it. On the other hand, it presents the experience of the voiceless by assembling pieces of the collective experience together.  We cannot reconstruct what the voiceless actually experienced, but we can reconstruct what they were likely to have experienced. The recurrence of certain experiences in interviews suggests that they could have been the possible experience of any victim. Testimonial fragments are meant to represent collective experiences; interviews behind fragments are the unique and individual manifestations of these collective experiences. <span className='italic'>Let Them Speak</span> as an anthology enables an effortless oscillation between the collective and the individual by opening reading paths that guide the reader through collective experiences. <span className='italic'>Let Them Speak</span> as an approach facilitates the shift from the study of testimonies as a collections of many individual experiences to the investigation of testimonies as an inventory of collective experiences. 
</p> 
