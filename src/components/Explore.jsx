...
const Explore = props => (
  <div>
    ...
    <div className='container'>
      <p>The volume of the data underlying <span className='italic'>Let Them Speak</span> exceeds what a human reader can explore without the power of computing tools. Interviews in this edition cover approximately 45 million individual words. Existing metadata, as well as other finding aids such as indexing and summaries, have hitherto been the main resource of help in the exploration of testimonies. Nevertheless, there is also need to search in the words of survivors. This does not only mean finding words in texts. Search also targets the identification of connections, similarities, and dissimilarities between interviews. Search also implies the retrieval of certain feelings and patterns of thought in the recollection of survivors. Of course, searching through 45 million words can produce results that are still too much to read and study. Search therefore needs to be complemented with options to narrow down results to certain groups of survivors such as for instance victims of a given camp. To fulfill these requirements, interviews were transformed into a linguistically annotated corpus enriched with metadata provided by the three collections.</p><Link to='/search'><b>Corpus Search &rarr;</b></Link><br/><br/>
