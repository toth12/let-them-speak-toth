  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <br />
        <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/all_interviews_with_titles_shelfmarks.csv" target="_blank">Here</a> you can find the list of all interviews, their titles, and shelf marks.
        </p>

        <p>
        <b>2. Interviewees giving more interviews</b>
        <br />
        Reading different testimonies by the same person is of great interest. In <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/interviewees_giving_more_interviews.csv" target="_blank">this</a> data file, you can find the list of those interviewees who are present in this edition with multiple testimonies.
        </p>

        <p>
        <b>3. Names of interviewees ordered by surnames</b>
        <br />
        The interactive search bar does not enable you to find interviewees in terms of their surnames (the reason is described in the <a href="/methods">Methodology</a> section); <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/interviewee_ordered_by_surnames.csv" target="_blank">here</a> you can download a list of interviewees with their surnames as a different field. Since surnames were identified with a computational approach, they are not always completely accurate. 
        </p>
        ...
        <br />
        Some of the interviews presented in this edition are not testimonies by one person; in these testimonies, interviewers talk to multiple victims. <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/interviews_with_multiple_interviewees.csv" target="_blank">Here</a> you can find a list of these interviews.
        </p>
        ...
        <br/> 
        - <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/interviews_without_ghettos.csv" target="_blank">Interviews without ghetto information</a>
         <br/> 
        - <a href="https://github.com/yale-fortunoff/lts-data/blob/main/data/interviews_without_camps.csv" target="_blank">Interviews without camp information</a>
         <br/> 
