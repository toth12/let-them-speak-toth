...
class Testimony extends React.Component {
  constructor(props) {
    ...
    this.state = {
      highlightId: null,
      timeId: null,
      selectedMediaIndex: props.selectedMediaIndex || 0,
    };
  }
  ...
  activateSentences() {
    ...
    for (
      let i = this.props.sentenceStart;
      i < this.props.sentenceEnd + 1;
      i++
    ) {
      let match = $("#s" + i);
          ...
          <div className="testimony">
            <div className="content">
              <Right
                ...
                setMediaIndexCallback={(i) =>
                  this.setState({ selectedMediaIndex: i })
                }
              />
...
const Right = (props) => (
  <div className="right">
    ...
    <div className="right-body">
      <Media {...props} selectedMediaIndex={props.selectedMediaIndex} />
      <Metadata
        setMediaIndexCallback={props.setMediaIndexCallback}
        testimony={props.testimony}
        selectedMediaIndex={props.selectedMediaIndex}
      />
    </div>
  </div>
);
...
const Left = (props) => (
  <div className="left">
    ...
    <div
      className="left-body transcript-text"
...
const NoMedia = (props) => {
  ...
  return (
    <div className="remote-media-link">
      The media content is not available at the moment; please visit the{" "}
    ...
    <div className="metadata-block">
      {window.location.href.includes("show_pdfs") && props.testimony.pdf_filds
        ? props.testimony.pdf_files.map((l) => (
            <a
              href={"https://collections.ushmm.org/oh_findingaids/" + l}
              target="_blank"
            />
          ))
        : null}
