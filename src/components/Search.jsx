...
const Instructions = props => (
  <div className='instructions'>
    ...
    <p>Interviews in <i>Let Them Speak</i> are also parts of a linguistic corpus, which is a collection of texts where certain types of properties about each word is available. Each word in <i>Let Them Speak</i> has two properties: the dictionary form (lemma) and the grammatical category of the word (part of speech). Returning to the previous example, this enables the retrieval of not only "I went" but also "I go". To activate the corpus search, user is now requested to use the Corpus Query Language [CQL]. (The development of a comprehensive user interface is underway). This is a pattern matching language that combines a great variety of information to match sequences of words in texts. </p>
    ...
    <p>Or the use of a similar pattern with different words can be used:</p>
