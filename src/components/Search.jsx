...
const Instructions = (props) => (
  <div className="instructions">
    ...
    <p>
      The corpus engine, BlackLab, empowering this project enables the searching
      of simple words and word sequences. By inserting <i>you</i> or{" "}
      ...
      search results in context, i.e. in the interview transcripts. (At the
      moment listening in context is not yet available; interviews are played
    ...
    <p>
      ...
      how metadata provided by each institution had been processed and what type
      of information is behind each metadata field.
    </p>

    <p>
      To activate a search in the collection of 2700 transcripts as a linguistic
      corpus, user is now requested to use the Corpus Query Language
      (henceforth, CQL). This is a pattern matching language used to extract
      information from large body of linguistically annotated texts. How CQL can
      be applied to extract information is explained through short use case
      examples with the following structure. First, a Holocaust related research
      problem that traditional word search cannot resolve is outlined. Second,
      how CQL can help to tackle the research problem is explained; readers are
      given examples of patterns written in CQL. A more comprehensive but not
      research problem centric guide on CQL can be found on the website of{" "}
      <a
        href="http://inl.github.io/BlackLab/corpus-query-language.html"
        target="_blank"
      >
        BlackLab Engine.{" "}
      </a>
    ...
    <p>
      ...
      part-of-speech category and abbreviated as <i>pos</i> here), as well as
      its dictionary form (named <i>lemma</i>) are identified and stored, which
      is a computer-assisted process called linguistic annotation. How the
      linguistic corpus was constructed out of interview transcripts is also
      explained in the <a href="/methods">Methodology</a> section. During the
      linguistic annotation, to describe the grammatical category of each word,
      the abbreviated forms defined by the{" "}
      <a href="https://doi.org/10.1007/978-94-010-0201-1_1" target="_blank">
        Penn Treebank Project
      </a>{" "}
      were used. Today, this is a de-facto standard of linguistic processing.
      The grammatical categories and their abbreviated forms used throughout the
      linguistic annotation of the interview corpus can be found{" "}
      <a
        href="https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html"
        target="_blank"
      >
        here.
      </a>
    ...
    <p>
      CQL can be used to match different textual and extra-textual layers of
      interview transcripts. It can be applied to retrieve individual words,
      sequences of multiple words, and entire sentences. In addition, it can
      help to find moments of for instance long silence, crying, and sighing in
      interviews. Here we name these moments paratextual events. Finally, these
      four layers can be combined and filtered with metadata by using the box
      appearing on the left side following a search. (Another fifth layer is the
      one that would distinguish segments by interviewers and interviewees; this
      layer is not yet available). Use case examples are organized according to
      these four layers.
    </p>
    ...
    <p>
      ...
      can formulate their CQL query in two different ways that are in fact the
      same.
    </p>
    <p>
    ...
    <p>
      The latter pattern is in fact a shortcut for a search the criterium of
      which is defined through the <i>word</i> attribute. Note that matching by
    ...
    <p>
      <br />
      <br />
      2. <b>Disambiguation with part-of-speech information</b>: <i>fly</i>{" "}
    ...
    <p>
      ...
      <i>fly</i> and if it is used as a verb. Second, when defining the content
      ...
      , readers will find the abbreviations of all grammatical categories used
      to annotate interview transcripts. But they will not find V; instead they
    ...
    <p>
      ...
      instance, one can find both <i>capo</i> and <i>kapo</i> in the
      transcripts.
    </p>
    <p>
      <b>Solution:</b>
    ...
    <p>
      ...
      absent or it can be present once. The query above can be also expressed
    ...
    <p>
      ...
      2.{" "}
      <b>
        Matching sequences with similar meaning through grouping operation:
      </b>{" "}
    ...
    <p>
      <code>
        ["I"] []&#123;0,5&#125;[word="never" | word = "n't" ] [lemma="forget"]
      </code>
    </p>

    <p>
      <code>["I"] []&#123;0,5&#125;[word="always"] [lemma="remember"]</code>
    </p>
    ...
    <p>
      <code>
        (["I"] []&#123;0,5&#125;[word="never" | word = "n't" ] [lemma="forget"])
        | (["I"] []&#123;0,5&#125;[word="always"] [lemma="remember"])
      </code>
    </p>
    ...
    <p>
      <br />
      <br />
      3. <w>Finding repetitive sequences:</w> <i>why, why, why</i> (content not
      yet available)
      <br />
      <br />
    </p>
    ...
    <p>
      <br />
      <br />
      1. <b>Finding rhetorical questions:</b>{" "}
      <i>
        Why should we wait for tomorrow? Please, if there is ever dear Lord, let
        it end today.
      </i>{" "}
    ...
    <p>
      <br />
      <br />
      2. <b>Finding moments with abrupt change of sentence subject:</b>  
      <i>
        You become like an animal. How do I hide, or how do I save myself? You
        don't stay there and think.
      </i>
      (content not yet available)
      <br />
      <br />
    ...
    <p>
      <br />
      <br />
      1. <b>Finding moments of silence:</b> long and short breaks by
      interviewees as signs of traumatic memories (content not yet available)
      <br />
      <br />
    </p>
    ...
    <p>
      <br />
      <br />
      2. <b>Finding moments of crying:</b> identifying memories of parents’
      crying accompanied by interviewee’s crying (content not yet available)
      <br />
      <br />
    </p>
  </div>
