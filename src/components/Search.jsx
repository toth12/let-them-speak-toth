...
const Instructions = props => (
  <div className='instructions'>
    ...
    <p>Attributes can be also combined. Consider, for instance, that you want to retrieve interviews where victims speak about working in a mine. To differentiate mine as a noun from mine as a possessive pronoun, you need to add the grammatical category as well. We do this by adding the attribute pos, and by defining the grammatical category with the pos attribute. When adding linguistic annotation, the grammatical category codes of the Penn Treebank Project were used. (See the complete list here: https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html)</p>
