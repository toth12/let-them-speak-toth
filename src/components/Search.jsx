...
const Instructions = props => (
  <div className='instructions'>
    ...
    <p>Interviews in <span className='italic'>Let Them Speak</span> are also part of a linguistic corpus, which is a collection of texts where certain types of properties about each word are available. Each word in <span className='italic'>Let Them Speak</span> has two properties: the dictionary form (lemma) and the grammatical category of the word (part of speech). Returning to the previous example, this enables the retrieval of not only I went but also I go. To activate the corpus search, the user is now requested to use the Corpus Query Language [CQL]. (The development of a comprehensive user interface is underway). This is a pattern matching language that combines a great variety of information to match sequences of words in texts.</p>
    <p>CQL can help to match individual words with certain attributes. Each word to be matched has to be written between square brackets:</p><p>[lemma="go"]</p>
    <p>Thanks to defining lemma or dictionary form as attribute, this pattern will retrieve the occurrences of not only went but also go, goes, and going.</p>
    <p>Attributes can be also combined. Consider, for instance, that you want to retrieve interviews where victims speak about working in a mine. To differentiate mine as a noun from mine as a possessive pronoun, you need to add the grammatical category as well. We do this by adding the attribute pos, and by defining the grammatical category with the pos attribute. When adding linguistic annotation, the grammatical category codes of the Penn Treebank Project were used. (<a href="https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html" target="_blank">See the complete list</a>)</p>
    ...
    <p>[lemma="I"] [lemma="go"]</p><p>This retrieves I go, I went but it does not retrieve for instance I will go, I could not go, etc. To face this, one can add a wild card.</p><p>[lemma="I"] [ ] [lemma="go"]</p> 
    ...
    <p>Only one word:</p><p>[lemma="I"] [ ]&#123;1&#125; [lemma="go"]</p>
    <p>One or two words:</p><p>[lemma="I"] [ ]&#123;1,2&#125; [lemma="go"]</p><p>The editor is working on a more comprehensive guide on CQL. Until these guidelines, two more topic-specific use scenarios are presented.</p>
    <p>A key moment in an interview is when the interviewee uses the expression, I will never forget. However, this can be expressed in many different ways: I cannot forget, I was unable to forget, I always remember, etc. If you simply search for remember, you are given tens of thousands of search results. CQL can help to narrow this search.</p>
    <p>[lemma="never"] []&#123;0,5} [lemma="forget"]</p><p>[lemma="always"] []&#123;0,5&#125; [lemma="remember"]</p>
