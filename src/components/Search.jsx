...
const Instructions = props => (
  <div className='instructions'>
    ...
    <p>The editor is working on a more comprehensive guide on CQL. Until these guidelines, two more topic-specific use scenarios are presented.</p>
