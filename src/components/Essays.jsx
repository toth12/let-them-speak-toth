...
const Essays = props => (
  <div>
    ...
    <div className='container'>
      ...
      <p>This part of <span className='italic'>Let Them Speak</span> features essays by Gabor Mihaly Toth on each experience domains presented in the anthology of fragments. Content is under development.</p>
      <Titles/>
    </div>
  </div>
)
