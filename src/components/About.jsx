...
const About = props => (
  <div className='about'>
    ...
    <div className='container'>
      ...
      <br/><br/><br/>
      <h2>Scholarship</h2>
      <p><i>Let Them Speak</i> as a data edition brings together a wide range of methods from data science, natural language processing and machine learning. <i>Let Them Speak</i> as a monograph features essays on victim’s perspective</p>
      <br/><br/><br/>
      <table className='image-trio'>
        <tbody>
          <tr>
