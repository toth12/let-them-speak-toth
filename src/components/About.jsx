...
const About = props => (
  <div className='about'>
    ...
    <h2>Short Introduction</h2>
      ...
      <br/><br/><br/>
      <h2>Data Edition</h2>
      <p>On the other hand, <i>In Search of the Drowned in the Words of the Saved</i> is a data edition of nearly 2700 English language Holocaust testimonies preserved in three major US collections. As a data edition, it offers new ways to engage with victims’ experience. To give voice to the <i>Drowned</i>, it renders pieces of collective suffering as testimonial fragments. This opens reading paths along the emotional, physical, and mental experiences of victims and presents the Holocaust from their perspective. To unlock survivors’ testimonies, it makes transcripts available as a linguistic corpus. Finally, <i>In Search of the Drowned in the Words of the Saved</i> enables the reading, listening, and watching of the 2700 testimonies it features. <br/><br/><br/>
      </p>
      <table className='image-trio'>
        <tbody>
          <tr>
            <td>
              <a href='/contents'>
                ...
                <div className='teaser'>Browse testimonies of Holocaust survivors by location, date, and demographic metadata and read or listen their experience</div>
              </a>
            </td>
            <td>
              <a href='/anthology'>
